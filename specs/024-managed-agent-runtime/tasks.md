...
- [X] T057 After validation, remove the legacy fail-and-requeue and eager-boot paths and retire their flags (FR-017 cleanup) in `backend/src/opencode/process-manager.ts`
