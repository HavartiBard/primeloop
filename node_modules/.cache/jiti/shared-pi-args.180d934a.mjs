...
var _mcpDirectToolAllowlist = await jitiImport("./mcp-direct-tool-allowlist.ts");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}

const THINKING_LEVELS = ["off", "minimal", "low", "medium", "high", "xhigh"];
const TASK_ARG_LIMIT = 8000;
const PROMPT_RUNTIME_EXTENSION_PATH = path.join(path.dirname((0, _nodeUrl.fileURLToPath)("file:///home/james/.pi/agent/npm/node_modules/pi-subagents/src/runs/shared/pi-args.ts")), "subagent-prompt-runtime.ts");
  ...
  if (input.tools?.length) {
    ...
    if (builtinTools.length > 0) {
      if (input.mcpDirectTools?.length) {
        builtinTools.push(...(0, _mcpDirectToolAllowlist.resolveMcpDirectToolNames)(input.mcpDirectTools, input.cwd));
      }
